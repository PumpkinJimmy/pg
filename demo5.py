...
class Board(core.DisplayObject, core.UpdateObject):
...
class GameScene(state.DisplayState, state.UpdateState):
    def __init__(self):
    ...
    def update(self, events):
        ...
        state.UpdateState.update_all(self, events)
        state.DisplayState.display_all(self)
